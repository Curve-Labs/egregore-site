// Serve the canonical memo artifact at egregore.xyz/memo while keeping
// the short URL in the browser and in social previews.

const SOURCE =
  "https://egregore-production-55f2.up.railway.app/api/artifacts/curvelabs/egregore-memo";

const OG_TITLE = "Egregore — Memo";
const OG_DESCRIPTION = "Why Egregore, in under 300 words.";
...
const OG_TAGS = [
  ...
  `<meta property="og:url" content="https://egregore.xyz/memo" />`,
...
export default async () => {
  try {
    ...
    return Response.redirect(
      "https://egregore.xyz/view/curvelabs/egregore-memo",
      307,
    );
  }
};
