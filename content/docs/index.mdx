...
- [Claude Code](https://docs.anthropic.com/en/docs/claude-code) — `npm install -g @anthropic-ai/claude-code` — or [OpenAI Codex CLI](https://developers.openai.com/codex) — `npm install -g @openai/codex`
