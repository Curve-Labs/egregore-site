...
Multiplayer AI use opens possibilities beyond solo use. These commands capture those coordination workflows as first-class primitives — asking, inviting, broadcasting, running long-lived explorations.
