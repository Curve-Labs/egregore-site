...
export const ARTICLE_CONTENT = {
  ...
  "towards-shared-minds": [
    { type: "lead", text: "Magical times are upon us. Yet it somehow feels atomised." },
    { type: "lead", text: "Everyone with their workflows, their agents, their terminals turning natural language into unprecedented capabilities, yet all they can share is stories of their single-player adventures. Our visceral rebellion against this status quo led us to Egregore." },
    { type: "divider" },
