...
export const ARTICLE_CONTENT = {
  ...
  "towards-shared-minds": [
    ...
    { type: "p", text: "As Alan Kay put it, \u201Cthe computer is an instrument whose music is ideas\u201D \u2014 and the interface determines which ideas are playable. The terminal makes AI composable in a way no other interface does. Egregore turns running AI in your terminal (currently Claude Code) into a multiplayer experience by using a shared memory system and specific commands which facilitate coordination workflows. This base capability has a few key implications: context generation becomes a byproduct of organizational flows; workspace and coordination space are unified in the most AI-native form factor, massively reducing switching and transaction costs; and organizational learning and adaptability which yields emergent capabilities downstream of needs." },
    { type: "p", text: "Since this is all genuinely new territory, let me share a few mental models for those who want to experiment with this. First off, Egregore is a relational context engine which proactively engages with your processes. Let it ask questions \u2014 presets for user responses are contextually generated but typing (or even better, speaking) your response will always yield better results. I refer to this as context gardening (as opposed to engineering): the overhead approaches zero as context surfaces are pegged to the edges of the organization, and these edges multiply as the organization interacts. Second, Egregore, with Claude Code, lives and operates on your file system. Make sure you sandbox the specific repositories you want to share with fellow egregorians. It is the living infrastructure of your group. Both its body and its soul will change through use. Lean into this and find ways to inscribe yourselves into the substrate for enhanced bi-directional sensing. Egregore uses commands like /activity, /handoff, /save and /reflect to crystallize specific workflows to reduce cognitive load (both tokens and neuroelectric) of coordinated work. They are heteronoetic schelling points \u2014 crystallized for speed and cohesion, but designed to be mutated and composed for variety and evolution." },
    { type: "divider" },
    ...
    { type: "p", text: "Before Egregore had a name, Oz and I had been experimenting for almost a year with dynamic knowledge graphs and emergent ontologies. Things we built somehow lacked a critical piece, which was hard to see at first. At some point we decided to radically recalibrate \u2014 to stop thinking about product, and to remodel how we think and work from scratch, without overly attaching to any form factor. Simply play \u2013 together. A few days later, at a cafe in Kreuzberg, we were deploying our AI-native \u201Clab OS\u201D, unsure where it would take us. Within a week we were exchanging handoffs every day, asking for context across workstreams, logging research. The magic hit fast. Every time we did something outside of Egregore we started questioning why \u2014 why pass on the opportunity to generate collective context? What followed was an insanely animated month for me, Oz and the Curve Labs team, obsessively dogfooding and shipping features. We can\u2019t wait to finally push this out, whether that means validating our visions or delusions." },
