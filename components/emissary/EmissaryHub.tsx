...
const EMISSARIES: Emissary[] = [
  ...
  },
  {
    ...
    name: "Forge",
    italic: true,
    desc: "Hands the receiver a brief and the bones of a small site. Iterates pages, copy, and structure, then returns a working build you can pick up and run.",
    meta: [["Stages", "5"], ["Run", "~40 min"], ["Best with", "Briefs"]],
    Sigil: SigilForge,
    draft: true,
  },
];
